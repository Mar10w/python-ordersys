def place_order(menu):
    ...
    while True:
        ...
        continue_ordering = input("Would you like to order anything else? (Type 'n' or 'N' to quit): ")
...
def update_order(order, menu_selection, menu_items):
    ...
    if menu_selection in menu_items:
        ...
        print(f"Menu item {menu_selection} is not valid. Please select a valid menu item.")
